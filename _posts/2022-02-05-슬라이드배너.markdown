...
<img src="https://github.com/gitul0515/gitul0515.github.io/blob/main/_posts/image/22_0205_3.png?raw=true" alt="수평 슬라이드 배너" height="80%" style="margin-left: 0">

상위 요소인 slide-container의 위치를 고정하고, overflow:hidden을 통해 영역을 벗어난 자식 요소를 감춘다. 결국 세 개의 slide 중 하나만 보이게 된다. 한편, slide들을 담은 slide-inner의 Y축 위치를 이동시킨다. 그러면 하나의 slide에서 다음 slide로 전환된다. 
